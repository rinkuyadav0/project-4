<%@page import="in.com.rays.proj4.model.StudentModel"%>
<%@page import="in.com.rays.proj4.util.ServletUtility"%>
<%@page import="in.com.rays.proj4.util.HTMLUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.com.rays.proj4.bean.StudentBean"%>
<%@page import="in.com.rays.proj4.controller.StudentListCtl"%>
...
<body>
<jsp:useBean id="cbean" class="in.com.rays.proj4.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="in.com.rays.proj4.bean.StudentBean" scope="request" ></jsp:useBean>

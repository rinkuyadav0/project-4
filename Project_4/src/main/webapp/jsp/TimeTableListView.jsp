<%@page import="in.com.rays.proj4.model.TimeTableModel"%>
...
<body >
<jsp:useBean id="bean" class="in.com.rays.proj4.bean.TimeTableBean" scope="request"></jsp:useBean>
...
<br>	
	<table border="3" width="100%" align="center" cellpadding=6px cellspacing=".6">

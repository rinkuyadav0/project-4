...
<jsp:useBean id="bean" class="in.com.rays.proj4.bean.CourseBean" scope="request"></jsp:useBean>
...
<table>
	...
	<td><input type="text" name ="name" placeholder="Enter Course Name" size="22" value="<%=DataUtility.getStringData(bean.getCourseName())%>">
...
<tr><th style="padding: 3px"></th></tr>	
	...
	<td><input type="text" name ="description" placeholder="Enter Description" size="22" value="<%=DataUtility.getStringData(bean.getDescription())%>">

...
<%@page import="in.com.rays.proj4.controller.StudentCtl"%>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td style="position: fixed"><font  color="red"><%=ServletUtility.getErrorMessage("lastname", request)%></font>
		 ...
		 <tr>
          ...
          <td><input type="text" name="dob" id="udate4" readonly="readonly" placeholder=" Date of Birth" size="20"  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 

<%@page import="in.com.rays.proj4.model.FacultyModel"%>
<%@page import="in.com.rays.proj4.bean.FacultyBean"%>
<%@page import="in.com.rays.proj4.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.com.rays.proj4.controller.FacultyListCtl"%>
...
<jsp:useBean id="bean" class="in.com.rays.proj4.bean.FacultyBean" scope="request"></jsp:useBean>
<jsp:useBean id="colbean" class="in.com.rays.proj4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="in.com.rays.proj4.bean.CourseBean" scope="request"></jsp:useBean>
...
<form action="<%=ORSView.FACULTY_LIST_CTL %>" method="post">
	...
	<table width ="100%" align="center">
		...
		<label>College Name :</label>
		 <%=HTMLUtility.getList("name", String.valueOf(bean.getCollegeId()), clist) %>
                   	
		&nbsp;
		<label>Course Name :</label>
		<%=HTMLUtility.getList("coursename", String.valueOf(bean.getCourseId()), colist) %>		
		&nbsp;

...
import in.com.rays.proj4.util.EmailBuilder;
import in.com.rays.proj4.util.EmailMessage;
import in.com.rays.proj4.util.EmailUtility;
...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			System.out.println(bean.getCreatedDatetime() + "Rinku1234");
			stmt.executeUpdate();
			conn.commit();
			stmt.close();
		} catch (Exception e) {
	...
	public void delete(UserBean bean) throws ApplicationException {
		...
		try {
			...
			stmt.executeUpdate();
			System.out.println("delet seccuss");
			conn.commit();
			stmt.close();
...
//		stmt.setInt(8, bean.getUnSuccessfulLogin();
...
//		stmt.setString(11,bean.getLock());
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		System.out.println("List search of user model ");
...
//		 System.out.println(bean.getFirstName());
		...
		if (bean != null) {
			if (bean.getId() > 0) {
				...
				System.out.println(sql+"pagination");
			}
			...
			if (bean.getUnSuccessfulLogin() > 0) {
				sql.append(" And Unsuccessfull_login = " + bean.getUnSuccessfulLogin());
			}
		...
		System.out.println(sql+ "list search queiry model");
	...
	public List list() throws ApplicationException {
		System.out.println("list list of user model");
		return list(0, 0);
	}
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
            System.out.println("list list of pagination user model ");
	 ...
	 * userData.setPassword(newPassword); try { update(userData); } catch
	 * (DuplicateRecordException e) { return false; } HashMap<String, String> map =
	 * new HashMap<String, String>(); map.put("login", bean.getLogin());
	 * map.put("password", bean.getPassword()); map.put("firstName",
	 * bean.getFirstName()); map.put("lastName", bean.getLastName()); String message
	 * = EmailBuilder.getForgetPasswordMessage(map); EmailMessage msg = new
	 * EmailMessage(); msg.setTo(bean.getLogin());
	 * msg.setSubject("Password has been reset"); msg.setMessage(message);
	 * msg.setMessageType(EmailMessage.HTML_MSG); EmailUtility.sendMail(msg); return
	 * true; }
	 */
	/**
	 * forgetpassword

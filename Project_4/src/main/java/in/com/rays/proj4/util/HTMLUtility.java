...
import in.com.rays.proj4.model.BaseModel;
...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
		...
		StringBuffer sb = new StringBuffer(
				"<select style='width: 180px;  height: 23px;' class='form-control' name='" + name + "'>");
		...
		if (select) {
			sb.append(
					"<option style='width: 180px;  height: 30px;' selected value=''>--------------Select--------------------`</option>");
		}
	...
	public static String getList(String name, String selectedVal, List list) {
		...
		StringBuffer sb = new StringBuffer(
				"<select style='width: 180px;  height: 23px;' class='form-control' name='" + name + "'>");
		System.out.println("from htmlutility stringbuffer");
		boolean select = true;
		if (select) {
			sb.append(
					"<option style='width: 180px;  height: 30px;' selected value=''>--------------Select-----------------`</option>");

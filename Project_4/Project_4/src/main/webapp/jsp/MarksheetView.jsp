<%@page import="in.com.rays.proj4.controller.MarksheetCtl"%>
...
<body>
 <jsp:useBean id="bean" class="in.com.rays.proj4.bean.MarksheetBean" scope="request"></jsp:useBean>
...
<center>
            ...
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="rollNo" placeholder="Enter RollNo" size="20"
                ...
                <tr><th style="padding: 3px"></th></tr>
                  ...
                  <td><input type="number" name="physics" maxlength="2" placeholder="Enter Physics Marks"  style="width:180px"
                ...
                <tr>
                    <th align="left">Chemistry<span style="color: red">*</span> :</th>
                     <td><input type="number" name="chemistry" maxlength="2" placeholder="Enter Chemistry Marks"  style="width:180px"
                ...
                <tr >
                  ...
                  <td><input type="number" name="maths" maxlength="2" placeholder="Enter Maths Marks"  style="width:180px"

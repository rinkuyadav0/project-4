...
<center>
          ...
          <!--   <table style="font-size: 20px"> -->
            <table>
                <tr>
                    ...
                    <td><input type="text" name="login" readonly="readonly" size="20" value="<%=DataUtility.getStringData(bean.getLogin())%>"readonly="readonly"></td>          
	...
	<tr><th style="padding: 3px"></th></tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="firstName" size="20"  value="<%=DataUtility.getStringData(bean.getFirstName())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>
                <tr>
                    ...
                    <td><input type="text" name="lastName" size="20"  value="<%=DataUtility.getStringData(bean.getLastName())%>">
   ...
   <tr><th style="padding: 3px"></th></tr>             
    ...
    <tr><th style="padding: 3px"></th></tr>
                <tr>
                    ...
                    <td><input type="text" name="mobileNo" size="20" maxlength="10" value="<%=DataUtility.getString(bean.getMobileNo())%>"></td>
...
<tr><th style="padding: 3px"></th></tr>
                <tr>
                    ...
                    <td><input type="text" name="dob" id="date" size="20" value="<%=DataUtility.getDateString(bean.getDob())%>">

<%@page import="in.com.rays.proj4.model.SubjectModel"%>
<%@page import="in.com.rays.proj4.model.CourseModel"%>
<%@page import="java.beans.beancontext.BeanContext"%>
<%@page import="in.com.rays.proj4.util.HTMLUtility"%>
<%@page import="in.com.rays.proj4.bean.CourseBean"%>
<%@page import="in.com.rays.proj4.controller.SubjectListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="in.com.rays.proj4.bean.SubjectBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="cobean" class="in.com.rays.proj4.bean.CourseBean"
		scope="request"></jsp:useBean>
	...
	<center>
		...
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label>Subject Name :</label> <%=HTMLUtility.getList("subjectname", String.valueOf(bean.getSubjectName()), slist)%>


						<label>CourseName :</label> <%=HTMLUtility.getList("coursename", String.valueOf(bean.getCourseName()), clist)%>
